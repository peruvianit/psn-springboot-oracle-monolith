            ...
            var o, s = {
				...
				each: function(e, t, n, i) {
					if (s.isObject(e) && !i)
						...
						for (var r = 0, c = e.length; c > r; r+=1) t.call(n, e[r], r, e)
				},
				merge: function(e, t) {
			...
			c = {
				options: {
					...
					markup: [
						...
						'{{options.message}} <a data-cc-if="options.link" class="cc_more_info" href="{{options.link || "javascript:void(0)"}}" onclick="this.target=\'_blank\';">{{options.learnmore}}</a></p>',
						'</div>',
						'</div>'
					]
				},
