...
(function (win, doc, undefined)
{
    ...
    */
    ...
    RG.SVG.text = function (opt)
    {
        ...
        for (var i in RG.SVG.text.defaults) {
            if (typeof i === 'string' && typeof opt[i] === 'undefined') {
                opt[i] = RG.SVG.text.defaults[i];
            }
        }
    ...
    */
    RG.SVG.measureText = function (opt)
    {
        ...
        if (opt.cache !== false && typeof RG.SVG.measuretext_cache == 'object' && RG.SVG.measuretext_cache[str]) {
            return RG.SVG.measuretext_cache[str];
        }

        
        if (!RG.SVG.measuretext_cache['text-span'] || opt.cache === false) {
