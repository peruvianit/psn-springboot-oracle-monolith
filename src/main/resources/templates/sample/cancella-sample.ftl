	...
	<div id="main-page-content" class="page-content page-sidebar clearfix">
		...
		<div class="row m-x-0">
			...
			<div class="col-md-8 p-a-0">
				...
				<form id="form-sample" name="sign-list" action="<@spring.url '/sample/cancella/conferma' />" method="post" autocomplete="off">
					...
					<button type="submit" class="btn btn-block btn-danger submit-btn isrelative" aria-label="Conferma" tabindex="1000">
						Conferma
						<span class="miuricon miur-trash-1 halign halign-pull-right m-r-5 icon-xtop-01 miuricon-sm"></span>
					</button>
				</form>
				
				<div class="m-t-15">
				<a href="<@spring.url '/sample/cancella/indietro' />"><span class="miuricon miur-freccia-indietro"></span> Torna alla lista</a>
				</div>
