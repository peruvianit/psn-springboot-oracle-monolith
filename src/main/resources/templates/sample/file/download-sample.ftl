<#include "../../layout/header.ftl">
	...
	<div id="main-page-content" class="page-content page-sidebar clearfix">
		...
		<h2 class="m-t-0 m-b-1">Download Sample</h2>
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-xs-12 col-md-6">
								<div class="data-show">
									<p class="data-text">
									<a href="<@spring.url '/sample/download/sample-pdf?codiceDocumento=1' />" target="_blank"><span class="miuricon miur-file-pdf"></span> Download(Demo)</a>
									</p>
								</div>
							</div>
						</div>
