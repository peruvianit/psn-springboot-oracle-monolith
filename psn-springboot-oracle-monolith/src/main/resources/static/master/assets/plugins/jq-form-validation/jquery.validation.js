        ...
        function extendOptions() {
            ...
            for (var method in options) {
                ...
                if (!_options[method] || !(options[method] instanceof Object)) {
					// saibal: typeof(options) != "undefined" &&
                    typeof(options) != "undefined" && options.debug && window.Debug.log({
                        'node': node,
                        'function': 'extendOptions()',
            ...
            // saibal: typeof(options) != "undefined" &&
            if (typeof(options) != "undefined" && options.debug && $.inArray(options.debug, _supported.debug !== -1)) {
