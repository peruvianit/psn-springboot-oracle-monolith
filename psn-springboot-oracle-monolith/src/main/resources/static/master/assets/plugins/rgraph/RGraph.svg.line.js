                        ...
                        (function (sequentialIndex)
                        {
                            hotspot.addEventListener(prop.tooltipsEvent, function (e)
                            {
                                ...
                                if (RG.SVG.REG.get('tooltip') &&
                                    RG.SVG.REG.get('tooltip').__index__ === index &&
                                    RG.SVG.REG.get('tooltip').__dataset__ === dataset &&
                                    RG.SVG.REG.get('tooltip').__object__.uid === obj.uid) { // Added on the 27th/6/2019
                                    return;
                                }
